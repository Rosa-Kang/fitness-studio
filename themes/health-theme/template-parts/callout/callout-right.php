...
/**
 * Template part for displaying Callout Right.
 *
...
<?php
$orientation = get_field('cr_orientation');
$title = get_field('cr_title');
$image = get_field('cr_image');
$text = get_field('cr_text');
$button_label = get_field('cr_button_label');
$button_link = get_field('cr_button_link');
$deco = get_field('cr_decoration');
...
<section class="symmetric wrapper px-4 py-6 mb-5">
  <div class="symmetric-body <?php echo $orientation; ?>">
    <div class="columns is-vcentered is-full-mobile has-text-centered is-flex">
      <div data-aos="fade-left" class="column is-5-tablet is-4-desktop
      ...
      <div data-aos="fade-right" class="column mt-4 is-vcentered is-7-tablet is-8-desktop <?php if ($orientation == 'right-oval') {
                                                                                            echo 'order-one';
                                                                                          } else {
                                                                                            echo 'order-two';
                                                                                          } ?>">
