...
<?php
$orientation = get_field('sm_bottom_orientation');
$title = get_field('sm_bottom_title');
$image = get_field('sm_bottom_image');
$text = get_field('sm_bottom_text');
$button_label = get_field('sm_bottom_button_label');
$button_link = get_field('sm_bottom_button_link');
$illust = get_field('sm_bottom_illust');
